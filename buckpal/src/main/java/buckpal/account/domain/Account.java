//: buckpal.account.domain.Account.java
...
/**
 * An account that holds a certain amount of money.
 *
 * An {@link Account} object only contains a window of the latest account
 * activities.
 *
 * The total balance of the account is the sum of a baseline balance that was
 * valid before the first activity in the window and the sum of the activity
 * values
 */
...
public class Account {
     ...
     *
     * Use to create a new entity that is not yet persisted
     */
    ...
    /**
     * Calculates the total balance of the account by adding the activity
     * values to the baseline balance
     */
    ...
    public boolean withdraw(Money money, AccountId targetAccountId) {
        ...
        Activity withdrawal = new Activity(this.id, this.id, targetAccountId,
